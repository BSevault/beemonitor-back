...
INSERT INTO `person` (id, first_name, last_name, email, pwd, phone, adress, is_admin, is_active) VALUES(11, 'Bob', 'Marley', 'bob@gmail.com', '$2y$10$B4RV/3h6MTlURhL3rdSHw.qHpz/FByVHFvoVGaiFRndtNA8i89c4u', NULL, NULL, 1, 1);
INSERT INTO `person` (id, first_name, last_name, email, pwd, phone, adress, is_admin, is_active) VALUES(12, 'Flea', 'Balzary', 'rhcp@gmail.com', '$2y$10$3sZo8zn5weZ39DqGiRgxleKIJCe4ZhoyS5z.YZmVlDffce1pxBssu', NULL, NULL, 0, 1);
INSERT INTO `person` (id, first_name, last_name, email, pwd, phone, adress, is_admin, is_active) VALUES(13, 'Les', 'Claypool', 'primus@gmail.com', '$2y$10$B4RV/3h6MTlURhL3rdSHw.qHpz/FByVHFvoVGaiFRndtNA8i89c4u', NULL, NULL, 0, 1);
...
INSERT INTO `apiary` (`id`, `name`, `latitude`, `longitude`, `creation_date`, `end_date`, `comment`, `is_active`, `person_id`) VALUES (24, 'magni', '-20.2113', '57.7917', '2007-01-02', '1993-01-06', 'Alias id dolore fugiat laboriosam laudantium consequatur. Cupiditate aperiam quos vitae. Non error nemo debitis tempora ex voluptatibus commodi ut. Iste incidunt sed sint quod nihil necessitatibus.', 1, 12);
INSERT INTO `apiary` (`id`, `name`, `latitude`, `longitude`, `creation_date`, `end_date`, `comment`, `is_active`, `person_id`) VALUES (25, 'sequi', '-14.1679', '-160.5431', '1993-02-04', '1975-12-08', 'Nihil dolor laudantium quaerat velit repellendus ea aperiam magnam. Animi omnis consectetur suscipit ratione.', 1, 12);
